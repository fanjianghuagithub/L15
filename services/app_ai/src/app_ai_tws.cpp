...
bool app_ai_tws_role_switch_direct(void)
{
    ...
    {
        app_ibrt_if_tws_switch_prepare_done_in_bt_thread(app_ai_get_ai_spec());
        return ret;
    }
    else
    {
...
bool app_ai_tws_role_switch_dis_ble(void)
{
    ...
    if (ble_connected)
    {
        ...
        bt_drv_ble_sup_timeout_set(ble_Conhandle, 15); //fix ble disconnection takes long time:connSupervisionTime=150ms
...
void app_ai_tws_role_swtich(void)
{
    TRACE(1,"[%s]", __func__);
