...
export I2S_IOMUX_INDEX ?= 0
export I2S_MCLK_IOMUX_INDEX ?=13
##### ANC DEFINE END ######
...
ANC_WITHOUT_BT ?= 0
#ANC_WITHOUT_BT   1:key    2:switch

ifeq ($(ANC_WITHOUT_BT),1)
KBUILD_CPPFLAGS += \
    -D__ANC_STICK_SWITCH_USE_KEY__\
    -D__SUPPORT_ANC_SINGLE_MODE_WITHOUT_BT__
else ifeq ($(ANC_WITHOUT_BT),2)
KBUILD_CPPFLAGS += \
    -D__ANC_STICK_SWITCH_USE_GPIO__\
    -D__SUPPORT_ANC_SINGLE_MODE_WITHOUT_BT__
endif
##### ANC DEFINE END ######
...
KBUILD_CPPFLAGS += \
    ...
    -D__FJH_LINEIN_BUG__ \
    -D__FJH_POWERONOFF_MAG__ \
    -D__FJH_BATTERY_REPORT__ \
    -D__FJH_SIRI_BUG__ \
    -D__FJH_LONG_UP_MSG__ \
    -D__FJH_LED_STRING__ \
    -D__FJH_CHARGEING_CLEAN_PAIR_LIST__ \
    -D__FJH_RECONNECT_BUG__ \
    -D__FJH_POWEROFF_MSG__ \
    -D__ANC_WARNING_TONG__ \
    -D__FJH_ANC_ONOFF_DELAY__ \
    -D__FJH_CLEAR_NV__ \
    -D__FJH_AMP_SW__ \
    -D__FJH_GSENSOR_DELAY_OPEN__ \
    -D__FLAG_UODOWN_LONGPRESS__ \
    -D__FJH_I2C_PSENSOR__ \
    -D__FJH_I2C_GSENSOR__ \
    -D__FJH_P_SENSOR_CORRECTION__ \
